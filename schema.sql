-- SmartPath Planner — Plain PostgreSQL Schema
-- No Supabase dependencies, no RLS, no auth.users references
-- Apply to the Dokku Postgres database after pressing "Add Postgres" in the dashboard.
