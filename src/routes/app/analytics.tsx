        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {isSuperAdmin && areas.length > 0 && (
            <select
              ...
              style={{ height: 40, padding: "0 14px", borderRadius: "var(--r-xl, 16px)", border: "1px solid var(--border)", background: "var(--card)", color: "var(--foreground)", fontSize: 13, cursor: "pointer", outline: "none" }}
            >
          ...
          <div ref={filterRef} style={{ position: "relative" }}>
            ...
            >
              ...
              {t("requests.filters")}
              {activeFilterCount > 0 && (
                <span style={{ background: "var(--primary)", color: "var(--primary-foreground)", borderRadius: 99, fontSize: 10, fontWeight: 700, minWidth: 18, height: 18, lineHeight: 1, display: "inline-flex", alignItems: "center", justifyContent: "center", padding: "0 5px" }}>
                  {activeFilterCount}
                </span>
              )}
            </button>
            ...
            {filterOpen && (
              <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, zIndex: 50, width: 340, background: "var(--card)", border: "1px solid var(--border)", borderRadius: "var(--r-card, 20px)", boxShadow: "0 12px 40px rgba(0,0,0,.3)", padding: 20, animation: "spIn .15s ease both" }}>
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                    <div><span style={{ display: "block", fontSize: 11, color: "var(--muted-foreground)", marginBottom: 4 }}>{t("common.from")}</span><input type="date" value={filterCreatedFrom} onChange={e => setFilterCreatedFrom(e.target.value)} style={{ width: "100%", height: 36, padding: "0 10px", borderRadius: "var(--r-sm, 10px)", border: "1px solid var(--border)", background: "var(--card)", color: "var(--foreground)", fontSize: 13, outline: "none" }} /></div>
                    <div><span style={{ display: "block", fontSize: 11, color: "var(--muted-foreground)", marginBottom: 4 }}>{t("common.to")}</span><input type="date" value={filterCreatedTo} onChange={e => setFilterCreatedTo(e.target.value)} style={{ width: "100%", height: 36, padding: "0 10px", borderRadius: "var(--r-sm, 10px)", border: "1px solid var(--border)", background: "var(--card)", color: "var(--foreground)", fontSize: 13, outline: "none" }} /></div>
                  </div>
                </div>
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                    <div><span style={{ display: "block", fontSize: 11, color: "var(--muted-foreground)", marginBottom: 4 }}>{t("common.from")}</span><input type="date" value={filterCompletedFrom} onChange={e => setFilterCompletedFrom(e.target.value)} style={{ width: "100%", height: 36, padding: "0 10px", borderRadius: "var(--r-sm, 10px)", border: "1px solid var(--border)", background: "var(--card)", color: "var(--foreground)", fontSize: 13, outline: "none" }} /></div>
                    <div><span style={{ display: "block", fontSize: 11, color: "var(--muted-foreground)", marginBottom: 4 }}>{t("common.to")}</span><input type="date" value={filterCompletedTo} onChange={e => setFilterCompletedTo(e.target.value)} style={{ width: "100%", height: 36, padding: "0 10px", borderRadius: "var(--r-sm, 10px)", border: "1px solid var(--border)", background: "var(--card)", color: "var(--foreground)", fontSize: 13, outline: "none" }} /></div>
                  </div>
                </div>

                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <button onClick={clearAllFilters} disabled={activeFilterCount === 0} style={{ background: "transparent", border: "none", padding: "4px 0", color: activeFilterCount === 0 ? "var(--muted-foreground)" : "#ef4444", fontSize: 13, cursor: activeFilterCount === 0 ? "default" : "pointer", opacity: activeFilterCount === 0 ? 0.45 : 1 }}>
                    {t("common.clearAll")}
                  </button>
                  <button onClick={() => setFilterOpen(false)} style={{ background: "var(--primary)", color: "var(--primary-foreground)", border: "none", borderRadius: "var(--r-sm, 10px)", padding: "7px 20px", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>
                    {t("common.apply")}
                  </button>
                </div>
              </div>
